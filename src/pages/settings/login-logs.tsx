...
import { getLoginLogs, deleteLoginLog, batchDeleteLoginLogs } from '@/services/login-log.service'
...
export default function LoginLogsPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['login-logs', page, pageSize],
    queryFn: () => getLoginLogs({ page, page_size: pageSize }),
  })
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: number) => deleteLoginLog(id),
    onSuccess: () => {
  ...
  const batchDeleteMutation = useMutation({
    mutationFn: (ids: number[]) => batchDeleteLoginLogs(ids),
    onSuccess: () => {
      toast.success(t('common.success'))
      queryClient.invalidateQueries({ queryKey: ['login-logs'] })
  ...
  const columns: ColumnDef<LoginLog>[] = [
    ...
    {
      accessorKey: 'user_id',
      header: t('settings.login_logs.user_id'),
    },
    {
      accessorKey: 'client',
      header: t('settings.login_logs.client'),
    },
    {
      accessorKey: 'device_id',
      header: t('settings.login_logs.device_id'),
    },
    {
      accessorKey: 'ip',
      header: t('settings.login_logs.ip'),
    },
    {
      accessorKey: 'type',
      header: t('settings.login_logs.type'),
    },
    {
      accessorKey: 'platform',
      header: t('settings.login_logs.platform'),
    },
    {
